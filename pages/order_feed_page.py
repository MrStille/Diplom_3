...
class OrderFeedPage(BasePage):
    ...
    def click_order_in_list(self, position_id):
        ...
        self.wait_element_visible(OrderFeedPageLocators.ORDERS_LIST)
    ...
    def check_order_details_pop_up(self):
        order_id = self.wait_element_visible(OrderFeedPageLocators.ORDERS_POPUP_ID).text
        order_price = self.wait_element_visible(OrderFeedPageLocators.ORDERS_POPUP_PRICE).text
    ...
    def get_total_orders_number(self):
        self.wait_element_visible(OrderFeedPageLocators.ORDERS_TOTAL_NUMBERS)
    ...
    def check_order_in_preparing_list(self, order_id):
        self.wait_element_has_text(OrderFeedPageLocators.PREPARING_ORDER_BLOCK, order_id)
    ...
    def wait_total_number_is_changed(self, current_number):
        self.wait_util_element_text_changes(OrderFeedPageLocators.ORDERS_TOTAL_NUMBERS, current_number)
        self.driver.refresh()
